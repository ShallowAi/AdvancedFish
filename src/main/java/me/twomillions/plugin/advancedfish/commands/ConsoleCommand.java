...
import me.twomillions.plugin.advancedfish.manager.BaitManager;
import me.twomillions.plugin.advancedfish.manager.FishManager;
...
public class ConsoleCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length == 0) {
            ...
            sender.sendMessage(CC.CHAT_BAR);
            sender.sendMessage(CC.translate("&e • &6您可以查看 Wiki 获取插件的基础教程内容: https://gitee.com/A2000000/advanced-fish/wikis"));
            sender.sendMessage(CC.CHAT_BAR);
            return true;
        }
        ...
        if (args[0].toLowerCase(Locale.ROOT).equals("reload")) {
            ...
            // 修复问题 -> https://gitee.com/A2000000/advanced-fish/issues/I60MHY
